...
wire   [18:0] lit_outStream_num_data_valid;
wire   [18:0] lit_outStream_fifo_cap;
wire    lenOffset_Stream_full_n;
wire   [63:0] lenOffset_Stream_dout;
wire    lenOffset_Stream_empty_n;
wire   [11:0] lenOffset_Stream_num_data_valid;
wire   [11:0] lenOffset_Stream_fifo_cap;
...
lz4CompressEngineRun_fifo_w8_d262144_B lit_outStream_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
lz4CompressEngineRun_fifo_w64_d2048_B lenOffset_Stream_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
