...
attribute shreg_extract : string;
    ...
    signal lit_outStream_num_data_valid : STD_LOGIC_VECTOR (18 downto 0);
    signal lit_outStream_fifo_cap : STD_LOGIC_VECTOR (18 downto 0);
    ...
    signal lenOffset_Stream_num_data_valid : STD_LOGIC_VECTOR (11 downto 0);
    signal lenOffset_Stream_fifo_cap : STD_LOGIC_VECTOR (11 downto 0);
    ...
    component lz4CompressEngineRun_fifo_w8_d262144_B IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        ...
        if_num_data_valid : OUT STD_LOGIC_VECTOR (18 downto 0);
        if_fifo_cap : OUT STD_LOGIC_VECTOR (18 downto 0) );
    end component;


    component lz4CompressEngineRun_fifo_w64_d2048_B IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    ...
    lit_outStream_U : component lz4CompressEngineRun_fifo_w8_d262144_B
    port map (
        clk => ap_clk,
        reset => ap_rst,
    ...
    lenOffset_Stream_U : component lz4CompressEngineRun_fifo_w64_d2048_B
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
