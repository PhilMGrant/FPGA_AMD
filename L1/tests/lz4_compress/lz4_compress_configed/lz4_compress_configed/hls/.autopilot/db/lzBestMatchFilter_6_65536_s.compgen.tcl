...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler lz4CompressEngineRun_sparsemux_13_3_32_1_1 BINDTYPE {op} TYPE {sparsemux} IMPL {compactencoding_dontcare}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_input_size_c1 \
    op interface \
    ports { input_size_c1_din { O 32 vector } input_size_c1_full_n { I 1 bit } input_size_c1_write { O 1 bit } input_size_c1_num_data_valid { I 3 vector } input_size_c1_fifo_cap { I 3 vector } } \
} "
}
