...
set portList { 
	...
	{ lit_outStream_num_data_valid sc_in sc_lv 19 signal 1 } 
	{ lit_outStream_fifo_cap sc_in sc_lv 19 signal 1 } 
	...
	{ lenOffset_Stream_num_data_valid sc_in sc_lv 12 signal 2 } 
	{ lenOffset_Stream_fifo_cap sc_in sc_lv 12 signal 2 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "lit_outStream", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "262144", "DependentChanType" : "0",
				"SubConnect" : [
			...
			{"Name" : "lenOffset_Stream", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2048", "DependentChanType" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	...
	lit_outStream { ap_fifo {  { lit_outStream_din fifo_data_in 1 8 }  { lit_outStream_full_n fifo_status 0 1 }  { lit_outStream_write fifo_port_we 1 1 }  { lit_outStream_num_data_valid fifo_status_num_data_valid 0 19 }  { lit_outStream_fifo_cap fifo_update 0 19 } } }
	lenOffset_Stream { ap_fifo {  { lenOffset_Stream_din fifo_data_in 1 64 }  { lenOffset_Stream_full_n fifo_status 0 1 }  { lenOffset_Stream_write fifo_port_we 1 1 }  { lenOffset_Stream_num_data_valid fifo_status_num_data_valid 0 12 }  { lenOffset_Stream_fifo_cap fifo_update 0 12 } } }
