...
module lz4CompressEngineRun_lzCompress_6_4_65536_6_1_4096_64_Pipeline_lz_compress_leftover (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
input  [7:0] select_ln82_4;
input  [7:0] select_ln82_3;
input  [7:0] select_ln82_2;
input  [7:0] select_ln82_1;
input  [7:0] select_ln82;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln205_fu_111_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln205_fu_111_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln205_fu_145_p2 = (ap_sig_allocacmp_m_1 + 3'd1);
...
assign icmp_ln205_fu_111_p2 = ((ap_sig_allocacmp_m_1 == 3'd6) ? 1'b1 : 1'b0);

assign outValue_fu_117_p11 = 'bx;

endmodule //lz4CompressEngineRun_lzCompress_6_4_65536_6_1_4096_64_Pipeline_lz_compress_leftover
