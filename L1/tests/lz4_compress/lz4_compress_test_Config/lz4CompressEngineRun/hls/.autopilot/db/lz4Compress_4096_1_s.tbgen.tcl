set moduleName lz4Compress_4096_1_s
set isTopModule 0
...
set cdfgNum 18
set C_modelName {lz4Compress<4096, 1>}
...
set portList { 
	...
	{ max_lit_limit sc_out sc_lv 32 signal 2 } 
	...
	{ lz4OutSize_din sc_out sc_lv 32 signal 5 } 
	{ lz4OutSize_full_n sc_in sc_logic 1 signal 5 } 
	{ lz4OutSize_write sc_out sc_logic 1 signal 5 } 
	{ ap_clk sc_in sc_logic 1 clock -1 } 
	{ ap_rst sc_in sc_logic 1 reset -1 active_high_sync } 
	{ max_lit_limit_ap_vld sc_out sc_logic 1 outvld 2 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "4", "7", "8", "9", "10"],
		...
		"IsBlackBox" : "0",
		"InputProcess" : [
			{"ID" : "1", "Name" : "lz4CompressPart1_4096_1_U0"}],
		"OutputProcess" : [
			{"ID" : "1", "Name" : "lz4CompressPart1_4096_1_U0"},
			{"ID" : "4", "Name" : "lz4CompressPart2_U0"}],
		"Port" : [
			{"Name" : "boosterStream", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "8", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "lz4CompressPart1_4096_1_U0", "Port" : "boosterStream"}]},
			{"Name" : "lz4Out", "Type" : "Fifo", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "4", "SubInstance" : "lz4CompressPart2_U0", "Port" : "lz4Out"}]},
			{"Name" : "max_lit_limit", "Type" : "Vld", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "lz4CompressPart1_4096_1_U0", "Port" : "max_lit_limit"}]},
			{"Name" : "input_size", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "lz4CompressPart1_4096_1_U0", "Port" : "input_size"}]},
			{"Name" : "lz4Out_eos", "Type" : "Fifo", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "4", "SubInstance" : "lz4CompressPart2_U0", "Port" : "lz4Out_eos"}]},
			{"Name" : "lz4OutSize", "Type" : "Fifo", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "4", "SubInstance" : "lz4CompressPart2_U0", "Port" : "lz4OutSize"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.lz4CompressPart1_4096_1_U0", "Parent" : "0", "Child" : ["2"],
		...
		"Port" : [
			{"Name" : "boosterStream", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "8", "DependentChanType" : "0",
				...
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_lz4CompressPart1_4096_1_Pipeline_lz4_divide_fu_114", "Port" : "boosterStream", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			{"Name" : "lit_outStream", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["4"], "DependentChan" : "7", "DependentChanDepth" : "4096", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_lz4CompressPart1_4096_1_Pipeline_lz4_divide_fu_114", "Port" : "lit_outStream", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			{"Name" : "lenOffset_Stream", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["4"], "DependentChan" : "8", "DependentChanDepth" : "32", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "lenOffset_Stream_blk_n", "Type" : "RtlSignal"}],
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_lz4CompressPart1_4096_1_Pipeline_lz4_divide_fu_114", "Port" : "lenOffset_Stream", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			{"Name" : "input_size", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.lz4CompressPart1_4096_1_U0.grp_lz4CompressPart1_4096_1_Pipeline_lz4_divide_fu_114", "Parent" : "1", "Child" : ["3"],
	...
	{"ID" : "3", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.lz4CompressPart1_4096_1_U0.grp_lz4CompressPart1_4096_1_Pipeline_lz4_divide_fu_114.flow_control_loop_pipe_sequential_init_U", "Parent" : "2"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.lz4CompressPart2_U0", "Parent" : "0", "Child" : ["5"],
		...
		"Port" : [
			{"Name" : "lit_outStream", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["1"], "DependentChan" : "7", "DependentChanDepth" : "4096", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "grp_lz4CompressPart2_Pipeline_lz4_compress_fu_91", "Port" : "lit_outStream", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			{"Name" : "lenOffset_Stream", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["1"], "DependentChan" : "8", "DependentChanDepth" : "32", "DependentChanType" : "0",
				"SubConnect" : [
	...
	{"ID" : "10", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.start_for_lz4CompressPart2_U0_U", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	boosterStream { ap_fifo {  { boosterStream_dout fifo_data_in 0 32 }  { boosterStream_empty_n fifo_status 0 1 }  { boosterStream_read fifo_port_we 1 1 } } }
	...
	input_size { ap_fifo {  { input_size_dout fifo_data_in 0 32 }  { input_size_empty_n fifo_status 0 1 }  { input_size_read fifo_port_we 1 1 } } }
