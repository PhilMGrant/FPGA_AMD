...
entity lz4CompressEngineRun_fifo_w64_d1024_S is 
    generic (
...
architecture rtl of lz4CompressEngineRun_fifo_w64_d1024_S is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component lz4CompressEngineRun_fifo_w64_d1024_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 64;
        ADDR_WIDTH : integer := 10;
        DEPTH      : integer := 1024);
...
begin
----------------------- Instantiation -----------------------
    U_lz4CompressEngineRun_fifo_w64_d1024_S_ShiftReg : lz4CompressEngineRun_fifo_w64_d1024_S_ShiftReg
    generic map (
...
entity lz4CompressEngineRun_fifo_w64_d1024_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 64;
        ADDR_WIDTH : integer := 10;
        DEPTH      : integer := 1024);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end lz4CompressEngineRun_fifo_w64_d1024_S_ShiftReg;

architecture rtl of lz4CompressEngineRun_fifo_w64_d1024_S_ShiftReg is
