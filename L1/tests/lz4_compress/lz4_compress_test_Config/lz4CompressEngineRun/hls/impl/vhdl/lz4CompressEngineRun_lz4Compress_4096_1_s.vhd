...
attribute shreg_extract : string;
    ...
    signal lit_outStream_num_data_valid : STD_LOGIC_VECTOR (17 downto 0);
    signal lit_outStream_fifo_cap : STD_LOGIC_VECTOR (17 downto 0);
    ...
    signal lenOffset_Stream_num_data_valid : STD_LOGIC_VECTOR (10 downto 0);
    signal lenOffset_Stream_fifo_cap : STD_LOGIC_VECTOR (10 downto 0);
    ...
    component lz4CompressEngineRun_fifo_w8_d131072_B IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component lz4CompressEngineRun_fifo_w64_d1024_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    ...
    lit_outStream_U : component lz4CompressEngineRun_fifo_w8_d131072_B
    port map (
        clk => ap_clk,
        reset => ap_rst,
    ...
    lenOffset_Stream_U : component lz4CompressEngineRun_fifo_w64_d1024_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
